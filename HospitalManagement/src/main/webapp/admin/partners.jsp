                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <form method="post" accept-charset="UTF-8" action="${pageContext.request.contextPath}/admin/partners" style="display:inline;"
...
<div class="modal-backdrop" id="addModal">
    <div class="modal">
        <h3>🤝 Thêm đối tác</h3>
        <form method="post" accept-charset="UTF-8" action="${pageContext.request.contextPath}/admin/partners">
