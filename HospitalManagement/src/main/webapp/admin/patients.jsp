                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-edit btn-sm"
                                            onclick="openEditModal('${p.patientId}','${p.fullName}','${p.diagnosis}','${p.status}','${fn:substring(p.appointmentTime, 0, 5)}')">✏️</button>
                                        <form method="post" accept-charset="UTF-8" action="${pageContext.request.contextPath}/admin/patients" style="display:inline;"
...
<div class="modal-backdrop" id="addModal">
    <div class="modal">
        ...
        <form method="post" accept-charset="UTF-8" action="${pageContext.request.contextPath}/admin/patients">
